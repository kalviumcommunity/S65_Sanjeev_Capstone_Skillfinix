...
const register = async (req, res) => {
  try {
    ...
    us.email = email + "bot";
    us.about =
      "Hi! I'm Bujji AI, built by Sanjeev Charavarthy. How can I assist you";
    us.profilePic =
      "https://res.cloudinary.com/dqqx7pcrv/image/upload/v1745212594/Bujji_s_profile_pic_inchhi.png";
...
const sendotp = async (req, res) => {
  try {
    ...
    let mailDetails = {
      ...
      to: email,
      subject: "Welcome to Skillfinix's SkillChat",
      ...
      <body>
              <strong><h1>SkillChat - an online SkillShare Chatting app</h1></strong>
          <div class="container">
            <h3>
            🎉 Welcome to SkillChat – Powered by Skillfinix! 🚀

Hey there, skill-swapper! 👋
You're now part of a vibrant community where learners become teachers, and knowledge flows both ways. Whether you're here to share your skills, learn something new, or just connect with like-minded people, SkillChat has your back.

💬 Start a conversation,
📚 Exchange your expertise,
🤝 Grow together!

Let’s build skills, spark conversations, and make learning a two-way street. 💡🔥
Ready to SkillChat? Let’s go! 🚀
